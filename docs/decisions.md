...
*Last updated: June 2026 (restored 2026-07-28 from git history, commit `c25337d`, after being deleted in `c310c6f` — footer corrected below, was never updated after the licensing decision on line 81 superseded it)*
*License: Proprietary (closed-source), 2-year minimum — see "Licensing model" decision above. This footer previously still said Apache 2.0, the superseded original choice — that was a pre-existing bug in this doc, not introduced by the restore.*
